...
struct soap*
SOAP_FMAC2
soap_versioning(soap_new)(soap_mode imode, soap_mode omode,const struct Namespace *p)
{ struct soap *soap = (struct soap*)malloc(sizeof(struct soap));
  if (soap)
    soap_versioning(soap_init)(soap, imode, omode,p);
  return soap;
}
#endif
...
void
SOAP_FMAC2
soap_initialize(struct soap *soap,const struct Namespace *p)
{ soap_versioning(soap_init)(soap, SOAP_IO_DEFAULT, SOAP_IO_DEFAULT,p);
}
#endif
...
void
SOAP_FMAC2
soap_versioning(soap_init)(struct soap *soap, soap_mode imode, soap_mode omode, const struct Namespace *p)
{ size_t i;
