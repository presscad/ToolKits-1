...
SOAP_FMAC1 void SOAP_FMAC2 soap_versioning(soap_init)(struct soap*, soap_mode, soap_mode,const struct Namespace *);
SOAP_FMAC1 void SOAP_FMAC2 soap_initialize(struct soap*,const struct Namespace *);
