...
#endif
#endif
#if defined(__NCSHARP_) || defined(__ALL_LICFUNC_)
//ProductType:12
struct NCSHARP_LICFUNC {	//NCSHARP
	/*Serial: 1*/static const char* FUNC_IDENTITY_BASIC;		//="628B0D79CDAFAE437EDA3F8286123049";
	/*Serial: 2*/static const char* FUNC_IDENTITY_OUTPUT_DXF;	//="D66B20634D48A95C65B5CE57AB773324"
	/*Serial: 3*/static const char* FUNC_IDENTITY_OUTPUT_PBJ;	//="54E3F0C6C89D225EEA619C97E8E8CB6C"
	/*Serial: 4*/static const char* FUNC_IDENTITY_OUTPUT_PMZ;	//="C1E5194CDF7E1FCC7595B83D2C77FF2A"
	/*Serial: 5*/static const char* FUNC_IDENTITY_HOLE_ROUTER;	//="7885C8457822A6981A161D7A380D9581"
};
//ProductType PRODUCT_NCSHARP 11#
//Serial  1's id string:'628B0D79CDAFAE437EDA3F8286123049'
//Serial  2's id string:'D66B20634D48A95C65B5CE57AB773324'
//Serial  3's id string:'54E3F0C6C89D225EEA619C97E8E8CB6C'
//Serial  4's id string:'C1E5194CDF7E1FCC7595B83D2C77FF2A'
//Serial  5's id string:'7885C8457822A6981A161D7A380D9581'
//Serial  6's id string:'9F13AB680F0A68D516F8DC923009D209'
//Serial  7's id string:'12E4632B16B56D7B2684669414E9D79C'
//Serial  8's id string:'D2FFD7299AB3E6A2EB977966DD10E6EF'
//Serial  9's id string:'97B27550491279B0A88A698C2E29B923'
//Serial 10's id string:'E69EF413358B666899F4BFC2CFD051EB'
//Serial 11's id string:'9CDB25EC2D2CDFFADB34EE038140E7A2'
//Serial 12's id string:'2095C2EEFFF1CFB957B00AB9970AFC59'
//Serial 13's id string:'F41351E236E118EA46D4AFE66739D3B2'
//Serial 14's id string:'8DB37BD65F7C54492C1E89E16C8E4E4B'
//Serial 15's id string:'C51D1F0068FF33284B2D3C794346090F'
//Serial 16's id string:'0FBAEF991FFD75CAE90F6CEA6B6A2B49'
//Serial 17's id string:'6DB6F069CC9392B46946C35B3CB1E7DC'
//Serial 18's id string:'86D5427D99A841541F856CCA14E68A46'
//Serial 19's id string:'A91D5EC23BDE32B7467BFB4D87799CF6'
//Serial 20's id string:'BFC52D09EA5721D97895457C366B26CA'
//Serial 21's id string:'3DC710AEBE9543A6715825366AB15520'
//Serial 22's id string:'F4E947FF7926B3D0869E54FD2328785B'
//Serial 23's id string:'B7B52EBCC9FBE584AC703276FA289F06'
//Serial 24's id string:'5F9FEA5398E1929617340BAEEDB1FB1B'
//Serial 25's id string:'02ECB2638ADA49B2FC8FA8883E7C8FE4'
//Serial 26's id string:'00789D9EC461E89B589AA6B81EA753B7'
//Serial 27's id string:'2FA3B87D58BB649AB8022A15E7C58345'
//Serial 28's id string:'E779C39A684BCA68E1FA963FF85140FB'
//Serial 29's id string:'52A7980797B57C08F1AB82770C7B00CE'
//Serial 30's id string:'2AC1033A6FD12C3B97A6FDF193E9CF7B'
//Serial 31's id string:'6CE0AC70FB87E51E7B445547D1AE1CCE'
//Serial 32's id string:'A7BA47258EB46A4E19A423410174A1B2'
#ifdef __NCSHARP_
#define LICFUNC NCSHARP_LICFUNC
#endif
#endif

#if defined(__NCS_) || defined(__ALL_LICFUNC_)
//ProductType:12
struct NCS_LICFUNC{	//NCS
