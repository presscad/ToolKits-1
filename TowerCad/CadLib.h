...
//	OBJHANDLE Ellipse( double cx, double cy, double ex, double ey, double Ratio, double StartParam=0.0, double EndParam=2*PI );
	...
	OBJHANDLE MText( LPCTSTR Text, double x1, double y1, double x2, double y2, double Height, 
	...
	//OBJECTS
	OBJHANDLE AddObject( OBJHANDLE BlockObjhandle, POBJECTHEADER pEntityHeader, LPVOID pEntityData );
	BOOL ChangeObject( POBJECTHEADER pEntityHeader, LPVOID pEntityData, LPCTSTR strBlockName=NULL );
	BOOL DeleteObject( LPCTSTR strBlockName, OBJHANDLE EntityObjhandle );
	OBJHANDLE FindObject( DWORD dwFindType, POBJECTHEADER pEntityHeader, LPVOID pEntityData, LPCTSTR strBlockName=NULL );
...
private:
	...
	OBJHANDLE (*drwAddObject)( HDRAWING hDrawing, OBJHANDLE BlockObjhandle, POBJECTHEADER pObjectHeader, LPVOID pObjectData );
	BOOL (*drwDeleteObject)( HDRAWING hDrawing, LPCTSTR strBlockName, OBJHANDLE ObjectHandle );
	BOOL (*drwChangeObject)( HDRAWING hDrawing, LPCTSTR strBlockName, POBJECTHEADER pObjectHeader, LPVOID pObjectData );
	OBJHANDLE (*drwFindObject)( HDRAWING hDrawing, LPCTSTR strBlockName, POBJECTHEADER pObjectHeader, LPVOID pObjectData, DWORD dwFindType );
