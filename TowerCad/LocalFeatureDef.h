...
/*   7 Feature's id string:*/static const char* BATCH_INTELLI_PRINT_PROCESSCARD;	//安徽宏源定制的批量打印角钢(圆钢)工艺卡功能
/*   8 Feature's id string:*/static const char* SAVEAS_FILE_VERSION;		//允许另存的旧格式数据文件版本
/*   9 Feature's id string:*/static const char* EXPORT_3DSOLID_DWGMODEL;	//生成三维实体DWG模型
