...
class Allocator {
  public:
    ...
    static string_view AllocString(Allocator* a, string_view str);
...
class PoolAllocator : public Allocator {
  ...
  public:
    explicit PoolAllocator() {minBlockSize=4096;allocRounding=8;currBlock=nullptr;currBlock=nullptr;}
...
class MaybeOwnedData {
  public:
    ...
    MaybeOwnedData(){data=nullptr;size=0;isOwned=false;}
