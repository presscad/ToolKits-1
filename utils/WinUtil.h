#ifndef __WIN_UTIL_H___
#define __WIN_UTIL_H___
...
bool LaunchFileFunc(const WCHAR* path, const WCHAR* params = nullptr, const WCHAR* verb = nullptr, bool hidden = false);
