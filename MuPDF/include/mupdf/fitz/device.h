...
float fz_set_draw_min_line_weight(float weight);
float fz_get_draw_min_line_weight();
float fz_set_draw_min_line_flatness(float flatness);
float fz_get_draw_min_line_flatness();
float fz_set_draw_max_line_weight(float weight);
float fz_get_draw_max_line_weight();
float fz_set_draw_max_line_flatness(float flatness);
float fz_get_draw_max_line_flatness();
/*
