...
public:
	...
	VARIANT AutoFit();
	//Format 1: Number;2: Font;4: Alignment;8: Border;16: Patterns;32: Width/Height
...
class FontLegacy : public COleDispatchDriver
{
public:
	FontLegacy() {}		// Calls COleDispatchDriver default constructor
	FontLegacy(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	FontLegacy(const FontLegacy& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
