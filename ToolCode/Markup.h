...
public:
	...
	// Navigate
	bool Load( MCD_CSTR_FILENAME szFileName,char *pStr=NULL);
	...
	// Create
	bool Save( MCD_CSTR_FILENAME szFileName ,char *pStr=NULL);
	...
	// Utility
	static bool ReadTextFile( MCD_CSTR_FILENAME szFileName, MCD_STR& strDoc, MCD_STR* pstrResult=NULL, 
		int* pnDocFlags=NULL, MCD_STR* pstrEncoding=NULL ,char *pStr=NULL);
	static bool WriteTextFile( MCD_CSTR_FILENAME szFileName, const MCD_STR& strDoc, MCD_STR* pstrResult=NULL,
		int* pnDocFlags=NULL, MCD_STR* pstrEncoding=NULL ,char *pStr=NULL);
